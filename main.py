    ...
    def parser(self, cmd_str):
        ...
        # Handling update_expense
            ...
            if len(cmd_str_lst) == 4:
                ...
                print("Error: Insufficient number of arguments. Usage: update_expense <expense_id> <field> <new_value>")
        ...
        # Handling delete_expense
            ...
            if len(cmd_str_lst) == 2:
                ...
                print("Error: Insufficient number of arguments. Usage: delete_expense <expense_id>")
